<section>
    <form wire:submit="submit">
        ...
        <div class="input-control">
            ...
            <input wire:model="email" type="email" name="email" id="emailInput" placeholder="mail@test.com" disabled>
        </div>
        @error('email')
        <label class="errorMessage">{{$message}}</label>
        @enderror
        ...
        <div class="input-control">
            ...
            <input wire:model="password_confirmation" type="password" name="password_confirmation"
                id="passwordConfirmationInput" placeholder="Repita la contraseña...">
        </div>
        ...
        <div class="input-control">
            ...
            <input wire:model="identification" type="text" name="identification" id="identificationInput"
                placeholder="Ingresa la cédula de identidad..." disabled>
        </div>
        ...
        <button type="submit"
            class="bg-[#4d55e4] text-white rounded tracking-[2px] uppercase font-semibold transition-all duration-[0.25s] ease-[ease-in] p-2 border-2 border-solid border-[#4d55e4];">Actualizar</button>
    </form>
</section>